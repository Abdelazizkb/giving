...
<div class="content-section justify-content-center">
    ...
    <form class="p-3" action="{{route('annonce.store')}}" enctype="multipart/form-data"  method="post" id="publier">
    @csrf
       ...
       <div class="d-block form-group row">
        <input type="submit" id="title" class="form-control orange border-rounded text-white"  value="Partager">
        </div>
