...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header orange text-white">
                    Roles
                    @permitTo('CreateRole')
                    <span class="float-right">
                        <a href="{{ route('admin.role.create') }}" class="btn btn-sm btn-default bg-white">Nouveau Role</a>
                    </span>
                    @endpermitTo
                </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="float-right">
                                ...
                                <a href="{{ route('admin.role.edit',$role->id) }}"
                                    class="btn btn-sm btn-primary mr-3">Modifier</a>
                                @endpermitTo
                            </div>
                        </li>
                        @endforeach
